public abstract class MembershipPlan implements Billable {
    ...
    public final void printSummary() {
        ...
        System.out.printf("Monthly net price: %.2f PLN%n", calculateMonthlyNetPrice());
        System.out.printf("Monthly gross price: %.2f PLN%n", calculateMonthlyGrossPrice());
        System.out.printf("Total contract net: %.2f PLN%n", calculateTotalNetPrice());
    }
