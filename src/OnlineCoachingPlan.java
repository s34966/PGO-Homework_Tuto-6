public class OnlineCoachingPlan extends MembershipPlan implements RemoteAccess {
    ...
    public String toString() {
        return super.toString() + " OnlineCoachingPlan{videoConsultations=" + videoConsultations
                + ", mealPlanIncluded=" + mealPlanIncluded + ", recordedLibraryAccess="
                + recordedLibraryAccess + "}";
    }
