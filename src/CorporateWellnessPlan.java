public class CorporateWellnessPlan extends MembershipPlan implements RemoteAccess, Freezable {
    ...
    private final int workshopsPerMonth;
    private final boolean onlineDashboard;
    ...
    public String toString() {
        return super.toString() + " CorporateWellnessPlan{employeeCount=" + employeeCount
